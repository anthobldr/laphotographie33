...
export default function PrestationsTarifs({ Prestations }: { Prestations: Prestation[] }) {
        ...
        <section className="container-fluid pb-5">
            ...
            <div className="row d-none d-lg-flex justify-content-lg-center gap-5 align-items-stretch">
                {Prestations.map((prestation, i) => (
                    <div key={i} className="col-lg-3 d-flex flex-column border rounded text-center py-4">
                        ...
                        <div className="text-center mt-3">
                            <ButtonPrimary text="RESERVER CETTE FORMULE" styleName="primaryOrange" />
                        </div>
                    </div>
                ))}
            </div>
