...
const articles = [
  {
    img: "article_1.jpg",
    categorie: "MARIAGE",
    title: "Comment préparer sa séance photo de mariage ?",
    desc: "Tous mes conseils pour préparer votre mariage et vivre une expérience photo seine et inoubliable.",
    date: "3 JUIN 2026",
  },
  {
    img: "article_2.jpg",
    categorie: "CONSEILS PHOTO",
    title: "Pourquoi choisir un photographe professionnel ?",
    desc: "Les garanties d’un travail de qualité et l’importance d’un regard artistique pour vos photos.",
    date: "3 JUIN 2026",
  },
  {
    img: "article_3.jpg",
    categorie: "MARIAGE",
    title: "Mes conseils pour des photos de mariage réussies",
    desc: "Lumière, timing, organisation: tous mes conseils pour des souvenirs inoubliables.",
    date: "3 JUIN 2026",
  },
];
const articlesCounts = articles.reduce(
  (compteur, article) => {
